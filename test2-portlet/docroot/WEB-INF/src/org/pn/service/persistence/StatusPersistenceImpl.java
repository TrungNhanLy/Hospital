...
import org.pn.NoSuchStatusException;

import org.pn.model.Status;
import org.pn.model.impl.StatusImpl;
import org.pn.model.impl.StatusModelImpl;
...
public class StatusPersistenceImpl extends BasePersistenceImpl<Status>
	 ...
	 */
	@Override
	public Status create(long status_no) {
		Status status = new StatusImpl();

		status.setNew(true);
		status.setPrimaryKey(status_no);
	 ...
	 */
	@Override
	public Status remove(long status_no)
		throws NoSuchStatusException, SystemException {
		return remove((Serializable)status_no);
	}
	...
	@Override
	public Status updateImpl(org.pn.model.Status status)
	...
	protected Status toUnwrappedModel(Status status) {
		...
		statusImpl.setStatus_no(status.getStatus_no());
		statusImpl.setStatus_detail(status.getStatus_detail());
		statusImpl.setId_patient(status.getId_patient());
	 ...
	 */
	@Override
	public Status findByPrimaryKey(long status_no)
		throws NoSuchStatusException, SystemException {
		return findByPrimaryKey((Serializable)status_no);
	}
	 ...
	 */
	@Override
	public Status fetchByPrimaryKey(long status_no) throws SystemException {
		return fetchByPrimaryKey((Serializable)status_no);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.pn.model.Status")));
