...
import org.pn.service.DrugLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.pn.service.impl.DrugLocalServiceImpl}.
 * </p>
 *
 * @author thuctap
...
public abstract class DrugLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DrugLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.pn.service.DrugLocalServiceUtil} to access the drug local service.
	 */
	...
	@Override
	public Drug addDrug(Drug drug) throws SystemException {
		drug.setNew(true);
	 ...
	 */
	@Override
	public Drug createDrug(long id_drug) {
		return drugPersistence.create(id_drug);
	}
	...
	@Override
	public Drug deleteDrug(long id_drug)
		throws PortalException, SystemException {
		return drugPersistence.remove(id_drug);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Drug deleteDrug(Drug drug) throws SystemException {
	...
	@Override
	public Drug fetchDrug(long id_drug) throws SystemException {
		return drugPersistence.fetchByPrimaryKey(id_drug);
	}
	 ...
	 */
	@Override
	public Drug getDrug(long id_drug) throws PortalException, SystemException {
		return drugPersistence.findByPrimaryKey(id_drug);
	}
	 ...
	 */
	@Override
	public List<Drug> getDrugs(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getDrugsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Drug updateDrug(Drug drug) throws SystemException {
		return drugPersistence.update(drug);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.pn.model.Drug",
			drugLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("org.pn.model.Drug");
	}
	...
	private DrugLocalServiceClpInvoker _clpInvoker = new DrugLocalServiceClpInvoker();
}