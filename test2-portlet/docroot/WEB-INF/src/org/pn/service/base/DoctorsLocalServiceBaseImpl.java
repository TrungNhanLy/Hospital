...
import org.pn.service.DoctorsLocalService;
...
/**
 * Provides the base implementation for the doctors local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.pn.service.impl.DoctorsLocalServiceImpl}.
 * </p>
 *
 * @author thuctap
 ...
 * @generated
 */
public abstract class DoctorsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DoctorsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.pn.service.DoctorsLocalServiceUtil} to access the doctors local service.
	 */
	...
	@Override
	public Doctors addDoctors(Doctors doctors) throws SystemException {
		doctors.setNew(true);

		return doctorsPersistence.update(doctors);
	}
	 ...
	 */
	@Override
	public Doctors createDoctors(long id_doctor) {
		return doctorsPersistence.create(id_doctor);
	}
	...
	@Override
	public Doctors deleteDoctors(long id_doctor)
		throws PortalException, SystemException {
		return doctorsPersistence.remove(id_doctor);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Doctors deleteDoctors(Doctors doctors) throws SystemException {
		return doctorsPersistence.remove(doctors);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Doctors.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return doctorsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return doctorsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return doctorsPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return doctorsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return doctorsPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Doctors fetchDoctors(long id_doctor) throws SystemException {
		return doctorsPersistence.fetchByPrimaryKey(id_doctor);
	}
	 ...
	 */
	@Override
	public Doctors getDoctors(long id_doctor)
		throws PortalException, SystemException {
		return doctorsPersistence.findByPrimaryKey(id_doctor);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return doctorsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Doctors> getDoctorses(int start, int end)
		throws SystemException {
		return doctorsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDoctorsesCount() throws SystemException {
		return doctorsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Doctors updateDoctors(Doctors doctors) throws SystemException {
		return doctorsPersistence.update(doctors);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.pn.model.Doctors",
			doctorsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.pn.model.Doctors");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = doctorsPersistence.getDataSource();
	...
	private DoctorsLocalServiceClpInvoker _clpInvoker = new DoctorsLocalServiceClpInvoker();
}