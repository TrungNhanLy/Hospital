...
import org.pn.service.BillsLocalService;
...
/**
 * Provides the base implementation for the bills local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.pn.service.impl.BillsLocalServiceImpl}.
 * </p>
 *
 * @author thuctap
 ...
 * @generated
 */
public abstract class BillsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BillsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.pn.service.BillsLocalServiceUtil} to access the bills local service.
	 */
	...
	@Override
	public Bills addBills(Bills bills) throws SystemException {
		bills.setNew(true);

		return billsPersistence.update(bills);
	}
	 ...
	 */
	@Override
	public Bills createBills(long bill_no) {
		return billsPersistence.create(bill_no);
	}
	...
	@Override
	public Bills deleteBills(long bill_no)
		throws PortalException, SystemException {
		return billsPersistence.remove(bill_no);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Bills deleteBills(Bills bills) throws SystemException {
		return billsPersistence.remove(bills);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Bills.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return billsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return billsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return billsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return billsPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Bills fetchBills(long bill_no) throws SystemException {
		return billsPersistence.fetchByPrimaryKey(bill_no);
	}
	 ...
	 */
	@Override
	public Bills getBills(long bill_no) throws PortalException, SystemException {
		return billsPersistence.findByPrimaryKey(bill_no);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return billsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Bills> getBillses(int start, int end) throws SystemException {
		return billsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBillsesCount() throws SystemException {
		return billsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Bills updateBills(Bills bills) throws SystemException {
		return billsPersistence.update(bills);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.pn.model.Bills",
			billsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("org.pn.model.Bills");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = billsPersistence.getDataSource();
	...
	private BillsLocalServiceClpInvoker _clpInvoker = new BillsLocalServiceClpInvoker();
}