...
import org.pn.service.RoomPatientLocalService;
...
/**
 * Provides the base implementation for the room patient local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.pn.service.impl.RoomPatientLocalServiceImpl}.
 * </p>
 *
 * @author thuctap
 ...
 * @generated
 */
public abstract class RoomPatientLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RoomPatientLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.pn.service.RoomPatientLocalServiceUtil} to access the room patient local service.
	 */
	...
	@Override
	public RoomPatient addRoomPatient(RoomPatient roomPatient)
		throws SystemException {
		roomPatient.setNew(true);

		return roomPatientPersistence.update(roomPatient);
	}
	 ...
	 */
	@Override
	public RoomPatient createRoomPatient(long room_no) {
		return roomPatientPersistence.create(room_no);
	}
	...
	@Override
	public RoomPatient deleteRoomPatient(long room_no)
		throws PortalException, SystemException {
		return roomPatientPersistence.remove(room_no);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RoomPatient deleteRoomPatient(RoomPatient roomPatient)
		throws SystemException {
		return roomPatientPersistence.remove(roomPatient);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RoomPatient.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return roomPatientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return roomPatientPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return roomPatientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RoomPatient fetchRoomPatient(long room_no) throws SystemException {
		return roomPatientPersistence.fetchByPrimaryKey(room_no);
	}
	 ...
	 */
	@Override
	public RoomPatient getRoomPatient(long room_no)
		throws PortalException, SystemException {
		return roomPatientPersistence.findByPrimaryKey(room_no);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return roomPatientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RoomPatient> getRoomPatients(int start, int end)
		throws SystemException {
		return roomPatientPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRoomPatientsCount() throws SystemException {
		return roomPatientPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RoomPatient updateRoomPatient(RoomPatient roomPatient)
		throws SystemException {
		return roomPatientPersistence.update(roomPatient);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.pn.model.RoomPatient",
			roomPatientLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.pn.model.RoomPatient");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = roomPatientPersistence.getDataSource();
	...
	private RoomPatientLocalServiceClpInvoker _clpInvoker = new RoomPatientLocalServiceClpInvoker();
}