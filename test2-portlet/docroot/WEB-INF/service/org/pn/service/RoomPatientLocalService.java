...
/**
 * Provides the local service interface for RoomPatient. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author thuctap
 * @see RoomPatientLocalServiceUtil
...
public interface RoomPatientLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RoomPatientLocalServiceUtil} to access the room patient local service. Add custom service methods to {@link org.pn.service.impl.RoomPatientLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
