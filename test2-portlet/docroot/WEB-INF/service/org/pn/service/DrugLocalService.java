...
/**
 * Provides the local service interface for Drug. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author thuctap
 * @see DrugLocalServiceUtil
...
public interface DrugLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DrugLocalServiceUtil} to access the drug local service. Add custom service methods to {@link org.pn.service.impl.DrugLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
