...
/**
 * Provides the local service interface for Doctors. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author thuctap
 * @see DoctorsLocalServiceUtil
...
public interface DoctorsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DoctorsLocalServiceUtil} to access the doctors local service. Add custom service methods to {@link org.pn.service.impl.DoctorsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
