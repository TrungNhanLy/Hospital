...
package org.pn.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			BillsLocalServiceUtil.clearService();

			DiagnosisLocalServiceUtil.clearService();

			DoctorsLocalServiceUtil.clearService();

			DrugLocalServiceUtil.clearService();

			MedicineLocalServiceUtil.clearService();

			PatientsLocalServiceUtil.clearService();

			RoomPatientLocalServiceUtil.clearService();

			StaffsLocalServiceUtil.clearService();
		}
	}
}